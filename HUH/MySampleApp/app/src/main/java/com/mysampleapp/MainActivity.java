...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setupNavigationMenu(final Bundle savedInstanceState) {
        ...
        //TODO: Add Menu Selections here

        DemoConfiguration.DemoFeature chats = new DemoConfiguration.DemoFeature();
        chats.iconResId = R.mipmap.icon_home;
        chats.titleResId = R.string.main_nav_menu_item_chats;
        navigationDrawer.addDemoFeatureToMenu(chats);
