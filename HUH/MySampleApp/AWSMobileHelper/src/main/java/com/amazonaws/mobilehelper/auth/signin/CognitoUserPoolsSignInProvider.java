...
public class CognitoUserPoolsSignInProvider implements SignInProvider {
    ...
    /** Log tag. */
    private static final String LOG_TAG = "COGSIGNIN*** " + CognitoUserPoolsSignInProvider.class.getSimpleName();
...
//                    activity.getString(R.string.sign_up_failed));
            ...
            Log.e(LOG_TAG, "Sign up failed.", exception);
            ViewHelper.showDialog(activity, "Sign up failed.","Please try again");
...
//                    activity.getString(R.string.sign_up_confirm_failed) + " " + exception);
            ...
            Toast.makeText(context, "Failed to confirm user.", Toast.LENGTH_LONG).show();
        }
    };
...
//                            + exception);
                    ...
                    //TODO: Sign in failure here

                    Log.d(LOG_TAG, "Login Failed");
                    ViewHelper.showDialog(activity, "Sign-in.","Login failed \nUser was not verified and resending confirmation code failed.");
